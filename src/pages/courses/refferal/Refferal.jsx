...
const Refferal = () => {
    return (
        <div className='discount my-[90px] rounded-xl'>

            <div className='p-10 text-white rounded-2xl flex flex-col sm:flex-row gap-5 items-start sm:justify-between sm:items-center'>
