...
const AdminDashboard = () => {
    ...
    return (
        <section>
            <div className='grid sm:grid-cols-2 xl:grid-cols-4 xl:items-center xl:justify-between gap-5 lg:gap-10 w-full px-2 lg:mx-0 mt-5'>
                ...
                <div className='  bg-black uppercase bg-opacity-70 h-[150px] flex flex-col justify-center items-center rounded-md text-white'>
                    <h5>Instructor</h5>
                    <h4 className='text-4xl font-bold'> 7</h4>
                </div>
                <div className='bg-error bg-opacity-60 h-[150px] flex flex-col justify-center items-center rounded-md text-white uppercase'>
                    <h5>Enrolled</h5>
