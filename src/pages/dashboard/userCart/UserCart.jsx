...
const UserCart = () => {
    return (
        <div className="w-full h-[calc(100vh-100px)] pr-20">
            <div className="overflow-x-auto h-3/4">
                <table className="w-full" id="userCart">
                    ...
                    <tbody className="">
                        ...
                        <tr className="hover:bg-primary-color hover:bg-opacity-10 px-20">
                            <td className="w-1/2 pl-3">
                                <div className="flex items-center space-x-3">
                                    <div className=" w-12 h-auto">
                                        <img src="/home/course2.png" alt="Course Image" className="w-full" />
                        ...
                        <tr className="hover:bg-primary-color hover:bg-opacity-[.15]">
                            <td className="w-1/2">
                                <div className="flex items-center space-x-3">
                                    <div className=" w-12 h-auto">
                                        <img src="/home/course2.png" alt="Course Image" className="w-full" />
