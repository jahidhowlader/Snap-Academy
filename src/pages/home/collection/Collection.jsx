        ...
        <section className="grid lg:grid-cols-3 gap-8 my-36 my-container">
            <div className="py-11 px-14 2xl:py-16 2xl:px-7 flex justify-end items-end  border-gray shadow-xl border-opacity-10 rounded-lg bg-gray bg-opacity-20 relative overflow-hidden">
                ...
                <div className="flex flex-col justify-end items-end">
                    <p className="text-lg font-medium text-primary-color">Only On Our Store!</p>
                    <h6 className="text-2xl 2xl:text-[32px] font-bold pb-7 text-primary-color">Snap Academy</h6>
            ...
            <div className="lg:col-span-2">
                ...
                <div className=" grid md:grid-cols-2 gap-8">
                    <div className="py-11 px-14 border border-gray shadow-xl border-opacity-10 rounded-lg bg-gray bg-opacity-20 relative overflow-hidden">
                        ...
                        <p className="text-lg font-medium text-primary-color">New Collection</p>
                        <h6 className="text-2xl 2xl:text-[32px] font-bold pb-7 text-primary-color">Wedding Plan</h6>
                        <button className="bg-primary-color py-2 px-5 rounded-lg text-white flex items-center gap-2">
                            Shop Now <HiArrowLongRight className="text-2xl" />
                        </button>
                    </div>
                    <div className="py-11 px-14 border border-gray shadow-xl border-opacity-10 rounded-lg bg-gray bg-opacity-20 relative overflow-hidden">
                        ...
                        <p className="text-lg font-medium text-primary-color">Upto 40% off</p>
                        <h6 className="text-2xl 2xl:text-[32px] font-bold pb-7 text-primary-color">The Most Sell</h6>
                        <button className="bg-primary-color py-2 px-5 rounded-lg text-white flex items-center gap-2">
                            Shop Now <HiArrowLongRight className="text-2xl" />
                        </button>
                    </div>
                ...
                <div className="py-11 px-14  border-gray shadow-xl border-opacity-10 rounded-lg bg-gray bg-opacity-20 mt-8 relative overflow-hidden">
                    ...
                    <p className="text-lg font-medium text-primary-color">Collection Of Editing    </p>
                    <h6 className="text-2xl 2xl:text-[32px] font-bold pb-7 text-primary-color">Photoshop / AI</h6>
                    <button className="bg-primary-color py-2 px-5 rounded-lg text-white flex items-center gap-2">
                        Shop Now <HiArrowLongRight className="text-2xl" />
                    </button>
                </div>
