        ...
        <section className='my-container sm:my-16 xl:my-24 2xl:my-32'>
            ...
            <div className='grid md:grid-cols-2 gap-5 '>

                {
                    ...
                    >
                        {/* Card Content */}
                        <div className='flex-1 order-2 lg:order-1 flex flex-col justify-between gap-3 md:gap-5 h-full p-3 sm:p-0'>
                            <div>
                                <h5 className='text-lg lg:text-xl font-medium'>{course.instructor}</h5>
                                <h3 className='font-bold text-xl xl:text-2xl text-primary-color py-1 sm:py-2 xl:pb-3 2xl:pb-4'>{course.title}</h3>
