    ...
    return (
        <section className="flex flex-col lg:flex-row items-center gap-10 justify-center my-container my-16 xl:my-24 2xl:my-32">
            ...
            <div className="flex-1 order-1 lg:order-2 text-center lg:text-left">
                <h3 className='text-2xl md:text-3xl lg:text-4xl font-bold text-primary-color pb-3 lg:pb-8'>See Video For <br /> more information</h3>

                <p className="2xl:text-lg pb-7 w-full sm:w-3/4 lg:w-full mx-auto px-5 lg:px-0">Dive into the world of photography fundamentals in our latest video. Uncover the magic of visual storytelling, master composition, and harness the power of light. 📷✨ For a deeper exploration, visit snapacademy.com. Lets embark on a creative journey together</p>
                {/* TODO: */}
